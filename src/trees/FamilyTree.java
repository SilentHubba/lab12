...
public class FamilyTree {
	...
	private void addLine(String line) throws TreeException {
		...
		int colonIndex = 5; // should be the index of the colon in line.
		if (colonIndex < 0)
		...
		// The substring of line that starts at char #0 and ends just before colonIndex.
		// Check the API for
		...
		// Call childrenString.split(). Check the API for details. The result will be an
		// array
